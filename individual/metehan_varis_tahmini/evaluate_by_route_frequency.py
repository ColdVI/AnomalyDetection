...
from individual.metehan_varis_tahmini.train_full import (
    TrajectoryDataset, collate, load_all_sessions, SESSIONS_DIR, SPLIT_PATH, MODEL_OUT, BEST_MODEL_OUT,
)
import json
...
def main(checkpoint: str = "best"):
    ...
    a_norm = build_normalized_adjacency(route_counts_archive, idents)
